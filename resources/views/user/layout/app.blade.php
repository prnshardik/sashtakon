            ...
            <section class="team py-md-5 py-3" id="team">
                <div class="container py-lg-5">
                    ...
                    <ul class="nav nav-pills mb-3" id="pills-tab1" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="pills-team1-tab" data-toggle="pill" href="#pills-team1" role="tab" aria-controls="pills-team1" aria-selected="true"><img src="{{ asset('frontend/images/team1.png') }}" class="img-fluid" alt="" /></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-team2-tab" data-toggle="pill" href="#pills-team2" role="tab" aria-controls="pills-team2" aria-selected="false"><img src="{{ asset('frontend/images/team2.png') }}" class="img-fluid" alt="" /></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-team3-tab" data-toggle="pill" href="#pills-team3" role="tab" aria-controls="pills-team3" aria-selected="false"><img src="{{ asset('frontend/images/team3.png') }}" class="img-fluid" alt="" /></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="pills-team4-tab" data-toggle="pill" href="#pills-team4" role="tab" aria-controls="pills-team4" aria-selected="false"><img src="{{ asset('frontend/images/team4.png') }}" class="img-fluid" alt="" /></a>
                        </li>
                    </ul>
                    <div class="tab-content" id="pills-tabContent1">
                        <div class="tab-pane fade show active" id="pills-team1" role="tabpanel" aria-labelledby="pills-team1-tab">
                            <div class="team-grids row">
                                <div class="col-md-6 margin">
                                    <img src="{{ asset('frontend/images/t1.png') }}" class="img-fluid" alt="" />
                                </div>
                        ...
                        <div class="tab-pane fade" id="pills-team2" role="tabpanel" aria-labelledby="pills-team2-tab">
                            <div class="team-grids row">
                                <div class="col-md-6 margin">
                                    <img src="{{ asset('frontend/images/t2.png') }}" class="img-fluid" alt="" />
                                </div>
                                <div class="col-md-6 team-margin">
                                    <h4>Alexander</h4>
                                    <h5>Wood engineer</h5>
                        ...
                        <div class="tab-pane fade" id="pills-team3" role="tabpanel" aria-labelledby="pills-team3-tab">
                            <div class="team-grids row">
                                <div class="col-md-6 margin">
                                    <img src="{{ asset('frontend/images/t3.png') }}" class="img-fluid" alt="" />
                                </div>
                                <div class="col-md-6 team-margin">
                                    <h4>Alexander</h4>
                                    <h5>Wood engineer</h5>
                        ...
                        <div class="tab-pane fade" id="pills-team4" role="tabpanel" aria-labelledby="pills-team4-tab">
                            <div class="team-grids row">
                                <div class="col-md-6 margin">
                                    <img src="{{ asset('frontend/images/t4.png') }}" class="img-fluid" alt="" />
                                </div>
                                <div class="col-md-6 team-margin">
                                    <h4>Alexander</h4>
                                    <h5>Wood engineer</h5>
